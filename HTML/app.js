...
bAdd.addEventListener('click', event => {
  ...
  const p = new Producto(inputsAdd.nombreP.value, inputsAdd.cantidadP.value, inputsAdd.costoP.value);
...
const producto = new Producto("caca", 2, 30);
const producto2 = new Producto("popo", 2, 30);
